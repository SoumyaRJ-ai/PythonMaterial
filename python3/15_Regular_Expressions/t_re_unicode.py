...
# re.fullmatch()
# The fullmatch(pattern, string, flags=0) performs an anchored search like match(),
# but returns a match object only if the expression matches the entire string OR
# the expression matches a portion of string denoted by span indexes specified in
# optional 2nd and 3rd arguments. Else, it returns None.
"""
